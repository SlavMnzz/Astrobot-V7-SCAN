...
global.APIKeys = {
    ...
    'https://skizo.tech' : 'Zxfrcv'
}

/*============== WATERMARK ==============*/
global.wm = '© 𝐀𝐬𝐭𝐫𝐨𝐛𝐨𝐭-𝐗𝐃' //Main Watermark
global.author = '𝐱𝐦𝐚𝐧𝐧𝐱𝐲𝐳.𝐝𝐞𝐯'
global.xzn = 'Zxfrcv'
global.openai = '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'  //api key bisa didapatkan dari https://openai.com/api/
global.org = 'org-OSB8qsFIJfuULURxvHDuL8fX'  //openAI Organization name
...
/*============== STICKER WM ==============*/
global.stickpack = '𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 𝑨𝒔𝒕𝒓𝒐𝒃𝒐𝒕𝑴𝑫'
global.stickauth = '𝒃𝒖𝒌𝒂𝒏 𝒎𝒂𝒉𝒇𝒖𝒅-𝒎𝒅'
