...
_⏩ ᴋᴇᴛɪᴋ .ᴀʟʟᴍᴇɴᴜ ᴜɴᴛᴜᴋ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ sᴇʟᴜʀᴜʜ ғɪᴛᴜʀ ʙᴏᴛ_
%readmore
...
📮ɴᴏ sᴇɴᴅ ᴠɪʀᴛᴇx
📮ɴᴏ sᴘᴀᴍ
📮ᴋᴀʟᴀᴜ ᴍᴀᴜ ᴍᴀsᴜᴋɪɴ ɢʀᴜᴘ ᴍᴜ, ɪᴊɪɴ ᴋᴇ ᴏᴡɴᴇʀ ᴅᴜʟᴜ
📮ᴅɪᴅᴀʟᴀᴍ ɢʀᴜᴘ ᴡᴀᴊɪʙ 1 ʙᴏᴛ sᴀᴊᴀ, ᴜɴᴛᴜᴋ ᴍᴇɴɢᴜʀᴀɴɢɪ ʀᴇsɪᴋᴏ ʙᴀɴɴᴇᴅ ᴏʟᴇʜ ᴡʜᴀᴛsᴀᴘᴘ !
`.trimStart(),
  header: '┌ ◦ %category ',
  body: '│ ◦ %cmd',
  footer: '└ ◦ ᴀ s ᴛ ʀ ᴏ - ᴍ ᴅ\n',
}
...
'vynaamenu': 'ʟ ɪ s ᴛ - ᴍ ᴇ ɴ ᴜ',
 ...
 let ihu = 'https://telegra.ph/file/606f3a3c8a5d6e7ccbb7d.jpg'
 
 conn.sendMessage(m.chat, {
      text: text,
      contextInfo: {
      externalAdReply: {
      title: `ᴀ s ᴛ ʀ ᴏ ʙ ᴏ ᴛ`,
      body: global.author,
      thumbnailUrl: ihu,
      sourceUrl: `https://chat.whatsapp.com/H1y1QmjuxQ16eAvMNv9UUs`,
      mediaType: 1,
