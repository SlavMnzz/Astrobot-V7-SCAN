...
let pesan = pickRandom(['ɴʏᴜᴍᴍᴍ~', 'ᴛʜᴀɴᴋs', 'ᴛʜᴀɴᴋʏᴏᴜ ^-^', '...', 'ᴛʜᴀɴᴋ ʏᴏᴜ~', 'ᴀʀɪɢᴀᴛᴏᴜ ^-^'])
    ...
    switch (type) {
        case 'fox':
            if (rubah == 0) return m.reply('ᴇɴ : ᴇɴ : ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !')
            ...
            break
        case 'cat':
            if (kucing == 0) return m.reply('ᴇɴ : ᴇɴ : ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !')
            ...
            break
        case 'dog':
            if (anjing == 0) return m.reply('ᴇɴ : ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !')
            ...
            break
        case 'horse':
            if (kuda == 0) return m.reply('ᴇɴ : ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !')
            ...
            break
            case 'robo':
            if (robot == 0) return m.reply('ᴇɴ : ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!\n\nɪᴅ : ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴍᴇᴍᴘᴜɴʏᴀɪ ᴘᴇᴛ !')
